...
const SettingsModal: React.FC<SettingsModalProps> = ({ onClose }) => {
    ...
    const tabs = [
        ...
        { id: 'localModels' as SettingsTab, label: 'Local Models', icon: Cpu }
    ];

    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center pointer-events-none animate-in fade-in duration-200">
            <div ref={modalRef} className="bg-white dark:bg-[#222222] w-full max-w-2xl h-[600px] rounded-xl shadow-2xl overflow-hidden flex pointer-events-auto">
                {/* Sidebar */}
                <div className="w-48 border-r border-[rgba(0,0,0,0.15)] dark:border-[rgba(255,255,255,0.05)] bg-[rgba(0,0,0,0.02)] dark:bg-[#1a1a1a] flex-shrink-0">
                ...
                <div className="flex-1 flex flex-col">
                    ...
                    <div className="space-y-3">
                        <div className="flex items-center gap-1.5">
                            ...
                            <h3 className="text-xs font-bold text-[#666666] dark:text-[#a0a0a0] uppercase tracking-wider">Default Model</h3>
                        </div>
                        <div className="bg-[rgba(68,133,209,0.1)] border border-[rgba(68,133,209,0.2)] dark:border-[rgba(68,133,209,0.3)] rounded-lg p-2">
                            <p className="text-xs text-[#1a1a1a] dark:text-white leading-relaxed">
                                ...
                                <div className="space-y-3">
                                    <div className="flex items-center justify-between">
                                        ...
                                        <div className={`flex items-center gap-1.5 px-2 py-0.5 rounded-full text-[10px] font-medium ${
                                            ...
                                            <div className={`w-1.5 h-1.5 rounded-full ${ragEnabled ? 'bg-green-500' : 'bg-gray-400'}`} />
                                ...
                                <div className="space-y-3">
                                    ...
                                    <div className="space-y-1">
                                        ...
                                        <input 
                                            ...
                                            className="w-full px-2.5 py-1.5 bg-[rgba(0,0,0,0.03)] dark:bg-[#1a1a1a] border border-[rgba(0,0,0,0.15)] dark:border-[rgba(255,255,255,0.05)] rounded-lg text-sm text-[#1a1a1a] dark:text-white focus:outline-none focus:ring-2 focus:ring-[rgba(68,133,209,0.2)] focus:border-[#4485d1] transition-all"
                                        />
                                        <p className="text-[12px] text-[#666666] dark:text-[#a0a0a0]">For Claude 3.5 Sonnet & other AWS models.</p>
                                    </div>
                                </div>
                            </>
                        )}
            ...
            {showSetupGuide && (
                <div className="bg-[rgba(0,0,0,0.03)] dark:bg-[#1a1a1a] border border-[rgba(0,0,0,0.15)] dark:border-[rgba(255,255,255,0.05)] rounded-lg p-2 text-xs text-[#666666] dark:text-[#a0a0a0] space-y-1.5 max-h-[150px] overflow-y-auto">
                    ...
                    <ol className="list-decimal list-inside space-y-0.5">
                        <li>Download and install Ollama from <a href="https://ollama.ai" target="_blank" rel="noopener noreferrer" className="text-[#4485d1] hover:underline">ollama.ai</a></li>
                        <li>Pull a model: <code className="bg-[rgba(0,0,0,0.06)] dark:bg-[#2a2a2a] px-1 rounded text-[12px]">ollama pull codellama</code></li>
                        <li>Ollama will run automatically on <code className="bg-[rgba(0,0,0,0.06)] dark:bg-[#2a2a2a] px-1 rounded text-[12px]">localhost:11434</code></li>
