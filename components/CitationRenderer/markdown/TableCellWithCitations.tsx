...
const TableCellWithCitations: React.FC<TableCellWithCitationsProps> = ({ text, files, onViewDocument, onOpenWebViewer, onOpenWebViewerNewTab, onViewImageAnnotation }) => {
